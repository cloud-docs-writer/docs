...
1. Начало установки продукта
   ...
   ![Шаг 1](../_assets/bitrix-website/bitrix-website-1.png)
...
1. Проверка главной страницы сайта
   ...
   Для этого в браузере перейдите по адресу `http://<публичный-IP-адрес-ВМ>/`. После этого вы окажетесь на главной странице сайта и увидите ее глазами пользователя, посетившего ваш интернет-магазин. Предварительно не забудьте **Выйти** из панели администрирования вашим сайтом, в правом верхнем углу страницы. 

   ![Шаг 5](../_assets/bitrix-website/bitrix-website-ip-check.png)
