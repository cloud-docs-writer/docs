...
```
Поиск требуемого параметра в редакторе `nano` осуществляется с помощью комбинации клавиш `Ctrl+W`. Найдите требуемый параметр из таблицы ниже, далее сохраните изменения при помощи комбинации клавиш `Ctrl+O`.  
