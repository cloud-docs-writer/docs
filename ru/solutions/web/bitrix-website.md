...
1. На странице каталога **Дашборд каталога** в [консоли управления]({{ link-console-main }}) нажмите кнопку **Создать ресурс** и выберите пункт [**Виртуальная машина**.](../_assets/bitrix-website/create-vm.png)
